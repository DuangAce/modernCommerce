...
function reslide_differ(elem1,elem2)  {
	return reslide_offset(elem1).left - reslide_offset(elem2).left;
} 
/**### DRAW SLIDER ###**/
...
function DrawSlider() {
					...
					switch(reslider["params"]["bullets"]["position"]) {
						case 0: 
							...
							var css_bullets_obj = {"left":reslider["params"]["bullets"]["style"]["position"]["left"],"top":reslider["params"]["bullets"]["style"]["position"]["top"]};
						...
						case 1: 
							...
							var css_bullets_obj = {"right":"","top":reslider["params"]["bullets"]["style"]["position"]["top"],"left":"","bottom":""};						
							var css_bullets = "top:"+reslider["params"]["bullets"]["style"]["position"]["top"];						
						break;	
						case 2: 
							reslider["params"]["bullets"]["autocenter"] = 0; 
							var css_bullets_obj = {"right":reslider["params"]["bullets"]["style"]["position"]["right"],"top":reslider["params"]["bullets"]["style"]["position"]["top"]};						
						...
						case 3: 
							...
							var css_bullets_obj = {"right":"","top":"","left":reslider["params"]["bullets"]["style"]["position"]["left"],"bottom":""};						
						...
						case 5: 
							reslider["params"]["bullets"]["autocenter"] = 2; 
							var css_bullets_obj = {"right":reslider["params"]["bullets"]["style"]["position"]["right"],"top":"","left":"","bottom":""};						
							var css_bullets = "right:"+reslider["params"]["bullets"]["style"]["position"]["right"];						
						break;		
						case 6: 
							reslider["params"]["bullets"]["autocenter"] = 0; 
							var css_bullets_obj = {"left":reslider["params"]["bullets"]["style"]["position"]["left"],"bottom":reslider["params"]["bullets"]["style"]["position"]["bottom"]};
							var css_bullets = "left:"+reslider["params"]["bullets"]["style"]["position"]["left"]+";bottom:"+reslider["params"]["bullets"]["style"]["position"]["bottom"];
						break;		
						case 7: 
							reslider["params"]["bullets"]["autocenter"] = 1; 
							var css_bullets_obj = {"left":"","bottom":reslider["params"]["bullets"]["style"]["position"]["bottom"],"right":""};
							var css_bullets = "bottom:"+reslider["params"]["bullets"]["style"]["position"]["bottom"];
						break;		
						case 8: 
							reslider["params"]["bullets"]["autocenter"] = 0; 
							var css_bullets_obj = {"left":"","bottom":reslider["params"]["bullets"]["style"]["position"]["bottom"],"right":reslider["params"]["bullets"]["style"]["position"]["right"]};
					...
					switch(reslider["params"]["effect"]["type"]) {
						case 0: 
							var reslide_effect = {$Duration:reslider["params"]["effect"]["duration"],$Opacity:2,$Brother:{$Duration:1000,$Opacity:2}};
						break;
						case 1: 
							 reslide_effect = {$Duration:reslider["params"]["effect"]["duration"],x:-0.3,y:0.5,$Zoom:1,$Rotate:0.1,$During:{$Left:[0.6,0.4],$Top:[0.6,0.4],$Rotate:[0.6,0.4],$Zoom:[0.6,0.4]},$Easing:{$Left:$JssorEasing$.$EaseInQuad,$Top:$JssorEasing$.$EaseInQuad,$Opacity:$JssorEasing$.$EaseLinear,$Rotate:$JssorEasing$.$EaseInQuad},$Opacity:2,$Brother:{$Duration:1000,$Zoom:11,$Rotate:-0.5,$Easing:{$Opacity:$JssorEasing$.$EaseLinear,$Rotate:$JssorEasing$.$EaseInQuad},$Opacity:2,$Shift:200}};						
						break;	
						case 2: 
							 reslide_effect = {$Duration:reslider["params"]["effect"]["duration"],x:0.25,$Zoom:1.5,$Easing:{$Left:$JssorEasing$.$EaseInWave,$Zoom:$JssorEasing$.$EaseInSine},$Opacity:2,$ZIndex:-10,$Brother:{$Duration:1400,x:-0.25,$Zoom:1.5,$Easing:{$Left:$JssorEasing$.$EaseInWave,$Zoom:$JssorEasing$.$EaseInSine},$Opacity:2,$ZIndex:-10}}
						break;						
						case 3: 
							 reslide_effect ={$Duration:reslider["params"]["effect"]["duration"],x:0.5,$Cols:2,$ChessMode:{$Column:3},$Easing:{$Left:$JssorEasing$.$EaseInOutCubic},$Opacity:2,$Brother:{$Duration:1500,$Opacity:2}}				
						break;							
						case 4: 
							 reslide_effect ={$Duration:reslider["params"]["effect"]["duration"],x:-0.1,y:-0.7,$Rotate:0.1,$During:{$Left:[0.6,0.4],$Top:[0.6,0.4],$Rotate:[0.6,0.4]},$Easing:{$Left:$JssorEasing$.$EaseInQuad,$Top:$JssorEasing$.$EaseInQuad,$Opacity:$JssorEasing$.$EaseLinear,$Rotate:$JssorEasing$.$EaseInQuad},$Opacity:2,$Brother:{$Duration:1000,x:0.2,y:0.5,$Rotate:-0.1,$Easing:{$Left:$JssorEasing$.$EaseInQuad,$Top:$JssorEasing$.$EaseInQuad,$Opacity:$JssorEasing$.$EaseLinear,$Rotate:$JssorEasing$.$EaseInQuad},$Opacity:2}}				
						break;	
						case 5: 
							 reslide_effect ={$Duration:reslider["params"]["effect"]["duration"],x:-1,y:-0.5,$Delay:50,$Cols:8,$Rows:4,$Formation:$JssorSlideshowFormations$.$FormationSquare,$Easing:{$Left:$JssorEasing$.$EaseSwing,$Top:$JssorEasing$.$EaseInJump},$Assembly:260,$Round:{$Top:1.5}}				
						break;		
						case 6: 
							 reslide_effect ={$Duration:reslider["params"]["effect"]["duration"],$Delay:30,$Cols:8,$Rows:4,$Clip:15,$SlideOut:true,$Formation:$JssorSlideshowFormations$.$FormationStraightStairs,$Easing:$JssorEasing$.$EaseOutQuad,$Assembly:2049}				
						break;									
					};
			...
			//	alert(i);
				setTimeout(function(){
					...
					var slides =  "";
						...
						for(slide in reslider["slides"]) {
							...
							for ( var slidecustom in reslider["slides"][slide]['custom']) {
								...
								if(reslider["slides"][slide]['custom'][slidecustom]['type'] == 'button') {	
									...
									staticElement.addAttr('u','any').addClass('reslidebutton').addStyle("background:none;padding:0;z-index:2;position:absolute;overflow:hidden;width:"+parseFloat(reslider["slides"][slide]['custom'][slidecustom]["style"]["width"])+"px;height:"+parseFloat(reslider["slides"][slide]['custom'][slidecustom]["style"]["height"])
						...
						/*
						var staticElement = _reslide();
						staticElement.addAttr('u','any').addStyle('position: absolute; top: 100px; left: 090px; width: 100px; height: 26px;');
						var innerStatic = _reslide('h1');
						innerStatic.addClass('gg');
						var t = document.createTextNode("Static 2 elemtn");
						innerStatic.append(t);	
						staticElement.append(innerStatic);		
						...
						for(var custom in reslider['custom']) {
							...
							if(reslider['custom'][custom]['type'] == 'button') {	
								...
								staticElement.addAttr('u','any').addClass('reslidebutton').addStyle("background:none;padding:0;z-index:2;overflow:hidden;position:absolute;width:"+parseFloat(reslider["custom"][custom]["style"]["width"])+"px;height:"+parseFloat(reslider["custom"][custom]["style"]["height"])
...
function csPopups(overlay,popup) {
	var overlay = overlay;
	var popup = popup;
...
var csPopupPreview =  new csPopups('reslide_slider_preview_popup','reslide_slider_preview');
var csPopupTitle =  new csPopups('reslide_slider_preview_popup','reslide_slider_title_styling');
var csPopupDesc =  new csPopups('reslide_slider_preview_popup','reslide_slider_description_styling');
var csPopupCustom ;
		

/*** creaste slidinf custom popups ***/		
		
function createStylingPopup(custom,customid) {
	//var custom = custom || 'button';
	...
	if(custom == "button" ) {
		...
		var divc = _reslide.html('<div class="reslide_content"></div>');
		 ...
		 content = [	
			...
			'<input  type="text" class="jscolor" id="custom-bullets-background-color-link"  name="custom['+customid+'][style][background][color]" rel="#" value="0FE923" >',
			'</span>',
			'<span class="color">',					
			'<label for="custom-background-color-hover">Hover Color:</label>',																			
			...
			'<span class="size">',
			'<label for="custom-border-size">Border Width:</label>',																			
			'<input  type="number"  id="custom-border-width" name="custom['+customid+'][style][border][width]" rel="px" value="4" >',	
			'</span>',					
			'<span class="color">',					
			'<label for="custom-border-color">Border Color:</label>',																			
			'<input  type="text" class="jscolor"  id="custom-custom-border-color" name="custom['+customid+'][style][border][color]" rel="#" value="000" >',		
...
document.onkeydown = function(evt) {
	...
	if (evt.keyCode == 27) {
		...
		csPopupTitle.hide();
		csPopupDesc.hide();
		if(csPopupCustom) csPopupCustom.hide();
		//jQuery('.reslide_slider_container_preview').remove();
		if(_reslide._('.reslide_slider_container_preview')[0]) {
			...
			//console.log('PARENT',_reslide(_reslide._('.reslide_slider_container_preview')[0]).parent());
		}
	}
};
...
/***  preview ***/			
			...
			//if(_reslide._('.reslide_close').length) {
...
/****/			
			...
			jQuery("#reslide_slide_edit > .close").click(function(){jQuery(this).parent().css('display','none');});
	...
	/*** slider general options ***/
		...
		_reslide._('#reslide-effect-type').on('change',function(){
			...
			//jQuery('#reslide-effect + input').val(value);
		});	
	...
	/*** arrow settings ***/
		...
		jQuery('#reslide-arrows-background input[type="radio"]').on('change',function(){
			...
			
			{
				...
				//alert(jQuery('#params-arrows-type').val());
				//reslider.params.arrows.type = jQuery('#params-arrows-type').val();
				getSliderParams();
				//alert(reslider.params.arrows.type);
			}
		});
	...
	/*** bullets settings ***/
		...
		function getSliderParams(custom) {
		...
		function setCustumFieldStyles(field,element) {
		...
		function drawCustumFieldStyles(field) {
			var field = field;
...
(function( $ ) {
	...
	if(document.getElementById('reslide-title-stylings')) {	
		document.getElementById('reslide-title-stylings').addEventListener('click',function(){
			getSliderParams();
			setCustumFieldStyles('title');
			drawCustumFieldStyles('title');
			csPopupTitle.show();
	...
	if(document.getElementById('reslide-description-stylings')) {	
		...
		document.getElementById('reslide-description-stylings').addEventListener('click',function(){
			getSliderParams();
			setCustumFieldStyles('description')
			drawCustumFieldStyles('description');		
			csPopupDesc.show();
	...
	if(document.getElementById('reslide-custom-stylings')) {
		document.getElementById('reslide-custom-stylings').addEventListener('click',function(e){
			...
			if(idstyle == 'title' || idstyle == 'description') 
			 ...
			 csPopupCustom =  new csPopups('reslide_slider_preview_popup','reslide_slider_'+idstyle+'_styling');	
			if(!getparamsFromUrl('slideid',location.href))
			getSliderParams('custom');
			else
			getSlideParams('slide'+getparamsFromUrl('slideid',location.href));	
			setCustumFieldStyles(idstyle,type)
			drawCustumFieldStyles(idstyle,true);
			csPopupCustom.show();
...
for(var i = 0;i<csconstruct.length;i++) {
	CSDRAG(csconstruct[i],'reslide-slider-construct');
...
var bl ,type;
		...
		_reslide._('#reslide-custom-add').on('click',function(){
			...
			var customCount = 0 ;// Pro _reslide._('.reslide_construct').length
			...
			createStylingPopup(type,type+id);
			_reslide(_reslide._('#reslide-custom-stylings')).addAttr('data',type+id);
			CreateDragElement(clas,type,'reslide-slider-construct');			
		})
...
function CreateDragElement(elementName,type,container) {
	...
	CSDRAG(newElement,container);
	document.getElementById(container).appendChild(newElement);
	//createStylingPopup(type);
...
function CSDRAG(dragElement,dragIn) {
...
//	console.log(bl);
	...
	CSDRAG.getCoords = function(elem) { 
	...
	function getOffsetLeft(elem){
	  ...
	  function moveAt(evnt,mover,shiftX,shiftY) {
		...
		if(Math.abs(RH-CH) < 3) {
			var coords = CSDRAG.getCoords(dragElement);
			...
			if(Math.abs(newDiffer - initDifferX) > 20) {
				mover.style.left = evnt.pageX - shiftX + 'px';jQuery('#reslide-construct-vertical').hide();
			}
			else jQuery('#reslide-construct-vertical').show();
		}
		else  {
		...
		if(Math.abs(RV-CV) < 3) {
			...
			else jQuery('#reslide-construct-horizontal').show();
		}		
		else  { 
			mover.style.top = evnt.pageY - shiftY + 'px';
	...
	dragElement.onmousedown = function(e) { 
		...
		zoom.style.left = parseFloat(CSDRAG.getCoords(dragElement).left)- parseFloat(CSDRAG.getCoords((_reslide._('#reslide-slider-construct'))).left)+dragElement.offsetWidth+'px';
		if(type != 'title' && type != 'description') {
			remove.style.display = 'block';
			remove.style.left = parseFloat(CSDRAG.getCoords(dragElement).left)- parseFloat(CSDRAG.getCoords((_reslide._('#reslide-slider-construct'))).left)+dragElement.offsetWidth-14+'px';
		}
		else 
			remove.style.display = 'none';
		...
		moveAt(e,dragElement,shiftX,shiftY);
...
/*** resize ***/
			...
			if(zoom)
				zoom.addEventListener('mousedown', initDrag, false);
			...
			function doDrag(e) {
			   ...
			   bl.style.height = (startHeight + e.clientY - startY) + 'px';
				jQuery(bl).find('.properties .w').text(parseInt(bl.style.width));	
				//console.log('TT',type);
				//console.log('width',bl.style.width);
			...
			//	jQuery(bl).find('.properties .w input').val(parseInt(bl.style.width));	
				jQuery(bl).find('.properties .h').text(parseInt(bl.style.height));	
				...
				//jQuery(bl).find('.properties .h input').val(parseInt(bl.style.height));	
