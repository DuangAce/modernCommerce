...
<div class="element hugeitmicro-item">
	<div class="left-block">
		<div class="main-image-block">
			<a href="http://huge-it.com/forms/" target="_blank"><img src="<?php echo plugins_url( '../images/form.png' , __FILE__ ); ?>"></a>
		</div>
	</div>
	<div class="right-block">
		<div class="title-block"><a href="http://huge-it.com/forms/" target="_blank"><h3>Wordpress Forms</h3></a></div>
		<div class="description-block">
			<p><?php echo __("Forms is one of the most important element for the WordPress website because without Forms Builder you will not be able to keep in touch with your visitors, partners and customers, give an easy filling form for submissions, delivery form or other types of forms. Besides that, a good-looking form gives your site a professional appearance.","product-catalog");?></p>
		</div>			  				
		<div class="button-block">
			<a href="http://huge-it.com/forms/" target="_blank"><?php echo __("View Plugin","product-catalog");?></a>
		</div>
	</div>
</div>
<div class="element hugeitmicro-item">
